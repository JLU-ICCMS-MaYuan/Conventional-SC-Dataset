...
\subsection{Prediction kept outside the reviewed database loop}
...
\texttt{paper\_images} & Paper ID, figure labels, original images, thumbnails, file size & Screenshot evidence and visual context \\
\texttt{users} & Email, real name, password hash, email verification, admin flags, approval state & Authentication, submission, review, and permission control \\
\bottomrule
\end{tabular}
\end{table}
