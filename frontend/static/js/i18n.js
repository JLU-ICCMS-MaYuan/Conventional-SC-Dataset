...
const I18N = {
    ...
    dict: {
        ...
        'index.formula_search': { zh: '化学式搜索', en: 'Formula Search' },
        'index.formula_search_placeholder': { zh: '输入化学式，例如 LaH10、FeSe1-xTex', en: 'Enter formula, e.g. LaH10 or FeSe1-xTex' },
        ...
        'compound.formula_sort': { zh: '化学式排序', en: 'Formula Sort' },
        'compound.formula_sort_relevance': { zh: '相关性', en: 'Relevance' },
        'compound.formula_sort_tc_desc': { zh: '最高 Tc 优先', en: 'Highest Tc' },
        'compound.formula_sort_tc_asc': { zh: '最低 Tc 优先', en: 'Lowest Tc' },
        ...
        'compound.mode_desc_formula': { zh: '模式：化学式相似搜索', en: 'Mode: Formula similarity search' },
