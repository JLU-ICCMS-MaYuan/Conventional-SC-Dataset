...
const I18N = {
    ...
    dict: {
        ...
        'index.select_hint': { zh: '点击元素进行选择，选中后再次点击可取消。选择完成后点击下方按钮或按Enter键进入化合物页面。', en: 'Click elements to select, click again to deselect. Press button or Enter to view compounds.' },
        ...
        'index.show_compounds': { zh: '进入化合物页面', en: 'View Compounds' },
        ...
        'compound.physical_data': { zh: '物理数据 (压强/Tc/λ等)', en: 'Physical Data (P/Tc/λ etc.)' },
