...
Conventional-SC-Dataset 是一个围绕“元素体系 - 超导体化学式 - 文献来源 - 超导记录 - 审核管理”组织的数据库型网站。核心目标不是做全文文献平台，而是让用户围绕特定元素组合快速查到超导体系、查看同一化学式在不同论文或来源中的压强点和超导数据、上传数据、审核数据并在首页图表中呈现结构化结果。
