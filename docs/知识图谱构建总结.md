...
**文件：** [backend/extract_relations.py](../backend/extract_relations.py)
...
**文件：** [backend/fix_resolve.py](../backend/fix_resolve.py)
...
**文件：** [backend/merge_relations.py](../backend/merge_relations.py)
...
**文件：** [backend/kg_enrich.py](../backend/kg_enrich.py)
...
**文件：** [backend/kg_enrich_fix.py](../backend/kg_enrich_fix.py)
...
**文件：** [backend/kg_sync.py](../backend/kg_sync.py)
...
**文件：** [backend/kg_import_relations.py](../backend/kg_import_relations.py)
...
**文件：** [backend/api/knowledge_graph.py](../backend/api/knowledge_graph.py), [backend/api/kg.py](../backend/api/kg.py)
